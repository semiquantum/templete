/**
 * Lumen Systems — Startup Company Template Script
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ==========================================================================
     ...
     ========================================================================== */
  const contactForm = document.querySelector('#startup-contact-form');
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (!isValid) {
        ...
        if (statusContainer) {
          ...
          statusContainer.textContent = 'Evaluation request received! Sandbox cluster provisioning credentials will be sent to your work email (Frontend Demo).';
        }
        contactForm.reset();
