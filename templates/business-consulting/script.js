/**
 * Northline Advisory — Business Consulting Template Script
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ==========================================================================
     ...
     ========================================================================== */
  const contactForm = document.querySelector('#consulting-contact-form');
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (!isValid) {
        ...
        if (statusContainer) {
          ...
          statusContainer.textContent = 'Thank you. Your consultation request has been submitted successfully (Frontend Demo).';
        }
        contactForm.reset();
