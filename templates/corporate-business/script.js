/**
 * Aster Group — Corporate Business Template Script
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ==========================================================================
     ...
     ========================================================================== */
  const contactForm = document.querySelector('#corporate-contact-form');
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (!isValid) {
        ...
        if (statusContainer) {
          ...
          statusContainer.textContent = 'Executive consultation request received. An Aster Group managing director will respond within 24 hours (Frontend Demo).';
        }
        contactForm.reset();
